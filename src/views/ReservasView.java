...
public class ReservasView extends JFrame {
	...
	public ReservasView() {
		...
		separator_1_2.setBounds(68, 194, 289, 2);
		...
		lblCheckIn.setBounds(68, 136, 235, 14);
		lblCheckIn.setFont(new Font("Roboto Black", Font.PLAIN, 18));
		panel.add(lblCheckIn);
		
		JLabel lblCheckOut = new JLabel("FECHA DE CHECK OUT");
		lblCheckOut.setForeground(SystemColor.textInactiveText);
		lblCheckOut.setBounds(68, 221, 235, 14);
		...
		lblValor.setBounds(72, 303, 231, 14);
		...
		txtFechaEntrada.setMinSelectableDate(dateActual);
		...
		txtFechaEntrada.setBounds(68, 160, 289, 36);
		txtFechaEntrada.getCalendarButton().setBounds(268, 0, 21, 33);
		txtFechaEntrada.setBackground(Color.WHITE);
		txtFechaEntrada.setBorder(new LineBorder(null, 0, true));
		txtFechaEntrada.setDateFormatString("yyyy-MM-dd");
		txtFechaEntrada.setFont(new Font("Roboto", Font.PLAIN, 18));
		panel.add(txtFechaEntrada);

		txtFechaSalida = new JDateChooser();
		txtFechaSalida.setMinSelectableDate(dateActual);
		...
		txtFechaSalida.setBounds(68, 245, 289, 36);
		...
		txtFechaSalida.setBorder(new LineBorder(new Color(255, 255, 255), 0, true));
		...
		txtValor.setBorder(new LineBorder(new Color(0, 128, 255), 0));
		panel.add(txtValor);
	...
	public void calcularValor(JDateChooser dateE,JDateChooser dateS) {
		...
		if (dateE.getDate()!= null && dateS.getDate()!= null) {
			if (dateE.getDate().after(dateS.getDate())) {
				JOptionPane.showMessageDialog(null, "Fechas invalidas.","",JOptionPane.ERROR_MESSAGE);
				return;
			}
